...
def main(sysArgs):
    ...
    # create context
    net.createContext(list(symbol_count.keys()), networkname="symbol_count_context_{}_{}".format(client.user, net.networkMappingType), minSize=0, maxSize=0)

    # create an annotation object
    node_annotation_object = get_annotation_object("count", symbol_count.keys(), symbol_count)
    net.annotate(annotationDict=node_annotation_object, networkname = sysArgs[1], doPrefixName=True)
